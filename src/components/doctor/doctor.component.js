    ...
    <div className="flex h-[100vh] w-[100vw]">
      ...
      <div className="flex flex-col items-center justify-start">
        ...
        <div className="flex p-3">
          <div className="h-[85vh] rounded-2xl w-[55vw] bg-azure m-2">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {
                  patientArray.length > 0 && patientArray.reverse().map((pat, index) => {
            ...
            {/* Popup */}
            {isPopupOpen &&
              <Popup selectedPatient={selectedPatient} setIsPopupOpen={setIsPopupOpen} />
            }
          </div>
...
const Popup = ({ selectedPatient, setIsPopupOpen }) => {



  const [prescriptionText, setPrescriptionText] = useState(selectedPatient.prescription ? selectedPatient.prescription : "");
  ...
  const handleSendData = async () => {
    try {
      if (file) {
        ...
        const apiKey = 'b77d1dc2.03388e97d51f4693a0c96958db575f70'
        ...
        axios.post(Url, formData, {
          ...
          axios.post(`${apiUrl}/patient/addreport`, { pId: selectedPatient.pId, report: res.data.Hash }).then((res) => {
            console.log(res)
          })
        })
      }
      axios.post(`${apiUrl}/case/attended`, { cId: selectedPatient.cId }).then(async (res) => {
        console.log(res)
      ...
      <div className="bg-white p-6 rounded-lg">
        ...
        <div>
          ...
          <textarea
            ...
            disabled={selectedPatient.attended}
          />
          <input
            type="file"
            accept=".jpeg, .jpg, .png"
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <select
              id="specialization"
              name="specialization"
              value={selectedPatient.attended ? selectedPatient.specialization : specialization}
              disabled={selectedPatient.attended}
              onChange={(e) => {
